...
function resizeImage(image, width, height, fileName, imageExtension) {
    return __awaiter(this, void 0, void 0, function () {
        var error_1, semiTransparentRedPng;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(image)
                            ...
                            .toFile('./public/thumbnails/' +
                            "".concat(fileName, "_").concat(width, "_X_").concat(height, ".").concat(imageExtension))
                            .then(function (data) {
                            console.log(data);
                            // send base64 string
                ...
                case 2:
                    ...
                    console.log(error_1);
                    return [3 /*break*/, 3];
                case 3: return [4 /*yield*/, (0, sharp_1.default)(image)
                        .resize({
                        width: width,
                        height: height,
                    })
